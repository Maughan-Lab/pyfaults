...
class TestSupercell(unittest.TestCase):
    ...
    def test_genSupercells(self):
        self.assertEqual(5, len(self.df['Model']))
        self.assertEqual(5, len(self.df['Stacking Vector']))
        self.assertEqual(5, len(self.df['Stacking Probability']))
        self.assertEqual(5, len(self.df['S_x']))
        self.assertEqual(5, len(self.df['S_y']))
        self.assertEqual(5, len(self.df['S_z']))
        self.assertEqual(5, len(self.df['P']))
